...
scenarios.csv: A nicely formatted csv file that shows how many points each person has and who wins the bracket challenge for each scenario (the output of bracket_scenarios.py):
